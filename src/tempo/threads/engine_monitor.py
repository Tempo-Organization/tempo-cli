...
from tempo import hook_states, logger, process_management, window_management
from tempo.data_structures import HookStateType
...
def engine_monitor_thread_logic():
    ...
    engine_window_name = unreal_engine.get_engine_window_title(
        tempo.settings.get_uproject_file()
    )
