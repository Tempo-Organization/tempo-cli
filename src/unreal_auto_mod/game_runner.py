from unreal_auto_mod import app_runner, hook_states, logger, settings, timer
...
def run_game_exe():
    app_runner.run_app(exe_path=settings.get_game_exe_path(), exec_mode=ExecutionMode.ASYNC, args=settings.get_game_launch_params())
