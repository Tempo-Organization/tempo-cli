...
def get_epic_launcher_exe_location():
    if sys.platform != "win32":
        invalid_os_error = "Epic Games Launcher path retrieval is only supported on Windows."
    ...
    for i in range(winreg.QueryInfoKey(reg_key)[0]):
        ...
        try:
            ...
            if "Epic Games Launcher" in display_name:
                ...
                return os.path.join(install_path, 'Portal', 'Binaries', 'Win32', 'EpicGamesLauncher.exe')
