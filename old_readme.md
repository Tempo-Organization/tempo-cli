...
This project uses several third-party tools in the backend.
Credit goes to the authors and contributors who built and maintain them.
All tools are used in accordance with their respective licenses.

- **Tool Name** – brief description  
  https://github.com/author/tool
